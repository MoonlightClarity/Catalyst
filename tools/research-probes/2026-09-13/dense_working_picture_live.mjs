...
const screenshotPath="C:/Users/iris/Downloads/Catalyst/tools/research-probes/2026-09-13/dense-working-picture-live.png";
fs.writeFileSync(screenshotPath,Buffer.from(shot.result.data,"base64"));
const result={...measure,screenshotPath};
fs.writeFileSync("C:/Users/iris/Downloads/Catalyst/tools/research-probes/2026-09-13/dense-working-picture-live.json",JSON.stringify(result,null,2));
