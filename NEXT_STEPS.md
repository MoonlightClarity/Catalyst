...
Status: **current execution order — 2026-09-15**

Catalyst is in late-alpha convergence. Do not start another feature cycle before the current Reader → Outline → generated Map → Methods / Techniques workflow is stable and the repository no longer contradicts itself.
...
Stress the Outline with create, rename, sibling/child insertion, reorder, indent/outdent, folding, trash/restore, keyboard navigation, and reload. Confirm the generated Map follows Outline hierarchy/order and cannot become an independent structural editor.
## 4. Exercise Methods / Techniques

Verify ordered runs, catalog discovery, genuinely blank/custom insertion, focused Name/Subtask/Analysis editing, subtask add/remove, run reordering/deletion, and reload. Keep Techniques independent from thoughts, Outline placement, Map nodes, and formal Assessment concepts.
