...
const manifest = manifestTemplate.replaceAll("__CATALYST_VERSION__", pkg.version);
...
console.log(
  `firefox stage: PASS — ${distFiles.length} Catalyst app files copied byte-for-byte to release/firefox`,
);
